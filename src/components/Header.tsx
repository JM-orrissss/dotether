...
export default function Header() {
    ...
    return (
        <header className="bg-[var(--color-primary)] flex items-center justify-between p-4 fixed top-0 left-0 right-0 z-10 font-rubik w-full text-white">
            ...
            {isMobile && (
                <>
                    <Button icon={<Icons.Burger size="large" />} aria-label={'Open Menu'} className="lg:hidden text-white flex-0" variant="tertiary" onClick={toggleMenu} underline={false} href="" />
                    <div
